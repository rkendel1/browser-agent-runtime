...
/**
 * Qwen3.5-4B, the family OpenJev pins for its own benchmark, quantized for
 * WebGPU. ~3.9 GB of VRAM: this is the reference configuration, not the one
...
/** A ~1.6 GB fallback for machines that cannot hold the 4B model. */
export const SMALL_DECISION_MODEL: PinnedDecisionModel = {
